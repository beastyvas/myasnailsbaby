      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white border border-stone-200 p-8 sm:p-12 space-y-10">
          ...
          <section>
            ...
            <div className="space-y-4 text-stone-700">
              <div><h3 className="font-semibold text-stone-900 mb-1">4.1 Deposits Are Non-Refundable</h3><p className="leading-relaxed">Your $20 deposit is non-refundable. Appointments can be rescheduled online. To cancel, please contact us directly; any goodwill applied to a future appointment is at our discretion.</p></div>
