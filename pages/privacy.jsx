        ...
        <div className="bg-white border border-stone-200 p-8 sm:p-12 space-y-10">
          ...
          <section>
            ...
            <div className="space-y-3 text-stone-700">
              ...
              <div><h3 className="font-semibold text-stone-900 mb-1">5.2 Textbelt</h3><p className="leading-relaxed">SMS messaging. See textbelt.com/privacy.</p></div>
          ...
          <section>
            ...
            <p className="text-stone-700 leading-relaxed mb-3">We do not sell, rent, or trade your personal information. We share information only with our service providers (Stripe, Textbelt, Resend, Supabase) as necessary to deliver our services, when required by law, or with your explicit consent.</p>
          </section>
