  ...
  return (
    <main className="min-h-screen bg-cream-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-cream-900 mb-2" style={sectionHeading}>Privacy Policy</h1>
        ...
        <div className="bg-white border border-cream-200 p-8 sm:p-12 space-y-10">
          ...
          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>1. Introduction</h2>
            <p className="text-cream-700 leading-relaxed mb-2">MyasNailsBaby is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our booking services.</p>
            <p className="text-cream-700 leading-relaxed">By using our services, you consent to the data practices described in this policy.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-4" style={sectionHeading}>2. Information We Collect</h2>
            <div className="space-y-4 text-cream-700">
              <div>
                <h3 className="font-semibold text-cream-900 mb-1">2.1 Personal Information</h3>
              ...
              <div>
                <h3 className="font-semibold text-cream-900 mb-1">2.2 Payment Information</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>3. How We Use Your Information</h2>
            <ul className="list-disc list-inside text-cream-700 space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-4" style={sectionHeading}>4. SMS Text Messaging</h2>
            <div className="space-y-4 text-cream-700">
              <div>
              ...
              <div>
                <h3 className="font-semibold text-cream-900 mb-1">4.3 Message Frequency</h3>
              ...
              <div>
                <h3 className="font-semibold text-cream-900 mb-1">4.4 Message and Data Rates</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>7. Data Security</h2>
            <p className="text-cream-700 leading-relaxed">We implement SSL/TLS encryption, secure access controls, and use PCI-DSS compliant payment processors. No method of internet transmission is 100% secure, but we take all reasonable precautions.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>8. Data Retention</h2>
            <p className="text-cream-700 leading-relaxed">We retain your personal information for as long as necessary to fulfill the purposes in this policy. Appointment records are typically retained for 3 years. Payment records are retained per financial record-keeping requirements.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>9. Your Privacy Rights</h2>
            <ul className="list-disc list-inside text-cream-700 space-y-1 ml-4">
            ...
            <p className="text-cream-700 leading-relaxed mt-3">To exercise these rights, contact us at (702) 981-8428 or myasnailsbaby@gmail.com. We will respond within 30 days.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>10. Children&apos;s Privacy</h2>
            <p className="text-cream-700 leading-relaxed">Our services are not directed to individuals under 18. We do not knowingly collect personal information from children.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>11. Changes to This Policy</h2>
            <p className="text-cream-700 leading-relaxed">We may update this Privacy Policy from time to time. We will notify you of significant changes by posting the updated policy with a new date. Continued use of our services constitutes acceptance.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-cream-900 mb-3" style={sectionHeading}>12. Contact Us</h2>
        ...
        <div className="mt-8 flex gap-6 text-sm text-cream-500">
          ...
          <Link href="/terms" className="hover:text-cream-900 transition">Terms of Service</Link>
        </div>
      </div>
    </main>
  );
